...
countries with numbers on a different order of magnitude would be possible (replace France (FR) with South Korea (KR) in the [URL](https://covid.aequologica.net/?day,confirmed,IT,SE,KR,2020-03-01,per,lin,18,_), then switch between logaritmic and linear Y axis : you will understand what I mean); 
